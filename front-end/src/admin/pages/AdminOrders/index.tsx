...
export interface IAdminOrdersProps {}

export interface IAdminOrdersState {
  isModalOpen: boolean;
}

export default class AdminOrders extends React.Component<IAdminOrdersProps, IAdminOrdersState> {
  state = {
    isModalOpen: true
  };
          ...
          <main className="col-md-10">
            ...
            <section className="order-list__section">
              ...
              <table className="content-table table table-striped table-sm mb-0">
                ...
                <tbody>
                  <AdminOrdersRow handleModalOpen={handleModalOpen} />
                </tbody>
              </table>
            </section>

            {/* <!-- 주문 상세 모달 --> */}
            <AdminOrdersModal isModalOpen={isModalOpen} handleModalClose={handleModalClose} />
          </main>
        </div>
      </>
    );
