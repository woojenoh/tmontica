...
export const FETCH_SET_POINT = "FETCH_SET_POINT";
export const FETCH_SET_POINT_FULFILLED = "FETCH_SET_POINT_FULFILLED";
export const FETCH_SET_POINT_REJECTED = "FETCH_SET_POINT_REJECTED";
